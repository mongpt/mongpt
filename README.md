...
![GitHub Actions](https://img.shields.io/badge/GitHub%20Actions-F7DF1E?logo=github-actions&logoColor=white)
![Microsoft Planner](https://img.shields.io/badge/Microsoft%20Planner-00599C?logo=microsoft&logoColor=white)
![Scrum](https://img.shields.io/badge/Scrum-802000?logo=scrum&logoColor=white)
![Jira](https://img.shields.io/badge/Jira-660066?logo=scrum&logoColor=white)  
...
| Project | Description |
|--------|-------------|
| 🤖 [**Smart IoT System Thesis**](https://github.com/mongpt/Smart_IoT_System_Thesis) | Custom I/O board for Raspberry Pi CM5, 3-port Fast Ethernet switch, and Python-based embedded system for real-time control of a multi-robot system. |
| 🔌 [**SmartPlug IoT Project**](https://github.com/mongpt/SmartPlug_IoT_Project) | IoT smart plug for remote control and monitoring of appliances. Features include real-time power tracking, scheduling, and safety limits. |
| 💨 [**RP2040 FreeRTOS-based Greenhouse CO₂ Controller**](https://github.com/mongpt/RP2040_FreeRTOS-based_Greenhouse_CO2_Controller_project) | CO₂ fertilization system using Raspberry Pi Pico W, FreeRTOS, and industrial sensors. Cloud-connected (ThingSpeak) for real-time greenhouse automation. |
| 🌀 [**RP2040-based Ventilation System Controller**](https://github.com/mongpt/RP2040-based_Ventilation_System_Controller_project) | Embedded system for smart ventilation and airflow control using MQTT, Raspberry Pi Pico, and environmental sensors. |
| 💊 [**Pill Dispenser Project**](https://github.com/mongpt/Pill_dispenser_project) | Automated pill dispenser to support timely medication intake. Includes real-time monitoring and logging for adherence tracking. |
| 📡 [**ESP8266-based Voting Client**](https://github.com/mongpt/ESP8266-based_voting_client) | Microcontroller-based wireless voting system with anonymous and registered voting capabilities. Focus on simplicity and scalability. |

## 🎓 Education

![B.Eng. IT](https://img.shields.io/badge/B.Eng.%20IT-FF5722)![](https://img.shields.io/badge/Metropolia%20UAS-blue)![](https://img.shields.io/badge/2025-2C3E50)  
![B.Eng. Electronics](https://img.shields.io/badge/B.Eng.%20Electronics-FF5722)![](https://img.shields.io/badge/Cantho%20University-blue)![](https://img.shields.io/badge/2007-2C3E50)  

## 🗣 Languages

![Vietnamese](https://img.shields.io/badge/Vietnamese-Native-brightgreen)  
![English](https://img.shields.io/badge/English-Upper%20Intermediate-yellow)  
![Finnish](https://img.shields.io/badge/Finnish-Beginner-lightgrey)
